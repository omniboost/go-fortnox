...
type ArticleRow struct {
	...
	DisposableQuantity StringFloat `json:"DisposableQuantity,omitempty"` // The quantity of the article that is available for sale.
	...
	VAT                StringFloat `json:"VAT,omitempty"`                // VAT percentage of the article.
...
type Article struct {
	...
	DisposableQuantity        StringFloat `json:"DisposableQuantity,omitempty"`
